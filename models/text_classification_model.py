...
import PML.nn
import PML.embeddings
from PML.data import Dictionary, Sentence, Label, DataPoint
from PML.datasets import SentenceDataset, DataLoader
from PML.file_utils import cached_path
from PML.training_utils import (
...
class TextClassifier(PML.nn.Model):
    """
    ...
    def __init__(
        self,
        document_embeddings: PML.embeddings.DocumentEmbeddings,
        ...
        self.document_embeddings: PML.embeddings.DocumentRNNEmbeddings = document_embeddings
    ...
    def forward(self, sentences):
        ...
        text_embedding_tensor = torch.cat(text_embedding_list, 0).to(PML.device)
    ...
    def _labels_to_one_hot(self, sentences: List[Sentence]):
        ...
        one_hot = torch.cat(one_hot, 0).to(PML.device)
        return one_hot
    ...
    def _labels_to_indices(self, sentences: List[Sentence]):
        ...
        vec = torch.cat(indices, 0).to(PML.device)
